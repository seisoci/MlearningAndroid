...
interface ApiInterface {
    ...
    @GET("api/history/{id}")
    @Headers("Accept: application/json")
    fun listhistorytugas(@Header("Authorization") token:String, @Path("id") id: String): Call<RHistoryTugas>
    ...
    fun updateStatus(@Header("Authorization") token:String, @Field("user_id") users_id: String?, @Field("mlearningmateri_id") materi_mlearning_id: String?): Call<RUpdateStatus>

    @FormUrlEncoded
    @Headers("Accept: application/json")
    @POST("api/absensi")
    fun addAbsensi(@Header("Authorization") token:String, @Field("user_id") users_id: String?, @Field("mlearningkelas_id") mlearningkelas_id: String?, @Field("mlearningmateri_id") mlearningmateri_id: String?): Call<RAbsensi>
